#decompiled by PDM31
import os, sys
print '\x1b[1;32mMasukan ID: hack dan Password: fb untuk Login dan jangan lupa login facebook di OperaMini dulu sebelum login agar tidak CekPoint'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6285240040679&text=Assalamualaikum')
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://github.com/Huntsx/hack/')
                time.sleep(2)
                menu()
